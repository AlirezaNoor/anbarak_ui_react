                ...
                <div className="sidebar-nav">
                     <ul className="metismenu" id="sidenav">
                        <li>
                            ...
                            <ul>
                                <li><a href="index-2.html"><i
                                    className="material-icons-outlined">arrow_left</i>تحلیل</a>
                                </li>
                                <li><a href="index2.html"><i className="material-icons-outlined">arrow_left</i>تجارت
                                    الکترونیک</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li><a href="widgets-data.html"><i className="material-icons-outlined">arrow_left</i>داده‌ها</a>
                                </li>
                                <li><a href="widgets-static.html"><i className="material-icons-outlined">arrow_left</i>استاتیک</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul>
                                <li><a href="app-emailbox.html"><i className="material-icons-outlined">arrow_left</i>جعبه
                                    ایمیل</a>
                                </li>
                                <li><a href="app-emailread.html"><i className="material-icons-outlined">arrow_left</i>ایمیل
                                    خوانده‌شده</a>
                                </li>
                                <li><a href="app-chat-box.html"><i className="material-icons-outlined">arrow_left</i>چت</a>
                                </li>
                                <li><a href="app-fullcalender.html"><i
                                    className="material-icons-outlined">arrow_left</i>تقویم</a>
                                </li>
                                <li><a href="app-to-do.html"><i className="material-icons-outlined">arrow_left</i>لیست
                                    کارها</a>
                                </li>
                                <li><a href="app-invoice.html"><i className="material-icons-outlined">arrow_left</i>فاکتور</a>
                                </li>
                            </ul>
                        </li>
