 ...
 <>
     ...
     <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasCart">
         <div class="offcanvas-header border-bottom h-70">
             <h5 class="mb-0" id="offcanvasRightLabel">۸ سفارش جدید</h5>
             ...
             <div class="order-list">
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">کفش مردانه سفید</h5>
                         <p class="mb-0 order-price">۲۸۹ دلار</p>
                     </div>
                     <div class="d-flex">
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">ایرپاد قرمز</h5>
                         <p class="mb-0 order-price">۱۴۹ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">تی‌شرت مردانه</h5>
                         <p class="mb-0 order-price">۱۳۹ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">جین آبی کژوال</h5>
                         <p class="mb-0 order-price">۴۸۵ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">پیراهن‌های شیک</h5>
                         <p class="mb-0 order-price">۷۵۸ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">ست مبل خانگی</h5>
                         <p class="mb-0 order-price">۵۴۶ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">آیفون مشکی</h5>
                         <p class="mb-0 order-price">۱۰۴۹ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
                 ...
                 <div class="order-item d-flex align-items-center gap-3 p-3 border-bottom">
                     ...
                     <div class="order-info flex-grow-1">
                         <h5 class="mb-1 order-title">ساعت طلایی</h5>
                         <p class="mb-0 order-price">۶۸۹ دلار</p>
                     </div>
                     <div class="d-flex">
                         <a class="order-delete"><span class="material-icons-outlined">delete</span></a>
                         <a class="order-delete"><span class="material-icons-outlined">visibility</span></a>
         ...
         <div class="offcanvas-footer h-70 p-3 border-top">
             <div class="d-grid">
                 <button type="button" class="btn btn-grd btn-grd-primary" data-bs-dismiss="offcanvas">مشاهده محصولات</button>
             </div>
         </div>
     </div>
